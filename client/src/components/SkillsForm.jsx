...
const SkillsForm = ({ data, onChange }) => {
    ...
    <div className="space-y-4">
      ...
      <div className="flex gap-2">
        <input
          ...
          placeholder="Enter a skill (e,g,. javascript, project manajment)"
        />
        <button
          onClick={addSkill}
  ...
  bg-blue-100 text-blue-800 rounded-full text-sm"
        ...
        <div className="text-cener py-6 text-gray-500">
          <Sparkles className="w-10 h-10 mx-auto mb-auto text-gray-300" />
      ...
      <div className="bg-blue-50 rounded-lg">
        <p>
          <strong>Tip:</strong> Add 8-12 relevant skills. inclide both technical
